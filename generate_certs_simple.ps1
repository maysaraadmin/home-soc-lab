...
Write-Host "Root CA: $indexerCertsDir\root-ca.pem"
Write-Host "Indexer certificates: $indexerCertsDir\wazuh.indexer.*"
Write-Host "Dashboard certificates: $dashboardCertsDir\wazuh-dashboard.*"
Write-Host "Admin certificate: $indexerCertsDir\admin.pem"
Write-Host ""
Write-Host "To complete the setup, please restart your Wazuh services using:"
